...
parser.add_argument('--dataset_path', type=str, default='../dataset/caltech_for_user/train', help='Dataset path')
parser.add_argument('--pre_trained', type=str, default=None, help='Pretrained checkpoint path')        #预训练模型
